public class NBody{
  ...
  public static void main(String[] args){
    ...
    StdOut.printf("%d\n", lotsPlanets.length);
    StdOut.printf("%.2e\n", universeRadius);
    for (int i = 0; i < lotsPlanets.length; i++) {
      StdOut.printf("%11.4e %11.4e %11.4e %11.4e %11.4e %12s\n",
                  lotsPlanets[i].xxPos, lotsPlanets[i].yyPos, lotsPlanets[i].xxVel,
                  lotsPlanets[i].yyVel, lotsPlanets[i].mass, lotsPlanets[i].imgFileName);
    }
  }
